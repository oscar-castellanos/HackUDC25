...
const Main = ({ imageURL, setImageURL, userName, prompt, setPrompt }) => {
  ...
  setTimeout(() => {
    if (isDoubleHidden) setIsDoubleHidden(false);
  }, 4000);
  ...
  useEffect(() => {
    ...
    if (capturedImage) {
      ...
      fetch(`http://localhost:8000/clothing_app/user_clothing/${userName}`, {
        ...
        body: JSON.stringify({ user: userName, image_string: capturedImage }),
      })
      ...
      <Container>
              ...
              <Col>
                <h4 className="mt-4" style={{ textAlign: "center" }}>
                  ...
                  {isHidden ? (
                    ...
                    <ReactTyped
                      strings={["uploading a picture of a cool outfit"]}
                      typeSpeed={50}
                      showCursor={false}
                    />
                  )}
              ...
              <Col>
                <h4 className="mt-4" style={{ textAlign: "center" }}>
                  ...
                  {isDoubleHidden ? (
                    ...
                    <ReactTyped
                      strings={["describing what you are looking for"]}
                      typeSpeed={50}
                      showCursor={false}
                    />
                  )}
              ...
              <Col>
                <Form onSubmit={startFromPrompt}>
                  <Form.Group controlId="formInputPrompt">
                    <Form.Control
                      type="text"
                      placeholder="I'm looking for an outfit with..."
                    />
                  </Form.Group>
        ...
        {isStarted && infoType === "prompt" && (
          <>
            <Row>
              <Col>
                <h2>You are looking for: "{prompt}"</h2>
              </Col>
            </Row>
            <Row xs={1} md={1} lg={2}>
              <Col>
        ...
        {capturedImage && (
          <Row xs={1} md={1} lg={2} className="mt-3 center mx-auto">
            <Col>
              <Button
                onClick={() => {
                  navigate("/compare");
